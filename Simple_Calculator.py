...
# Function to add a symbol to the calculation string and update the display
...
# Function to evaluate the calculation string and update the display
...
# Function to clear the calculation and update the display
def clear_field():
    global calculation
    calculation = ""
    text_result.delete(1.0, "end")

# Creating the main window of Calculator
root = tk.Tk()
root.geometry("300x275")
root.title("Simple Calculator") #set window size and title
